package cf.dashika.momyalbum.View.Fragment.EditMedia;
...
import cf.dashika.momyalbum.Adapter.EditMedia.ColorPickerAdapter;
...
public class TextEditorDialogFragment extends DialogFragment {
    ...
    public static TextEditorDialogFragment show(@NonNull FragmentActivity appCompatActivity,
    ...
    public static TextEditorDialogFragment show(@NonNull FragmentActivity fragmentActivity) {
        return show(fragmentActivity,
                "", ContextCompat.getColor(fragmentActivity, android.R.color.white));
    }
